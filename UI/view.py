...
class View(ft.UserControl):
    ...
    def load_interface(self):
        ...
        self.dd = ft.Dropdown(options=[])
        self._btnRaggiungibili = ft.ElevatedButton(text="Stati Raggiungibili", on_click=self._controller.handleConfinanti, disabled=True)
        row2 = ft.Row([self.dd, self._btnRaggiungibili], alignment=ft.MainAxisAlignment.CENTER)
